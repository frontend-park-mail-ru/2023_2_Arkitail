class Header extends Page {
    constructor(template) {
        ...
        this.template = Handlebars.compile(`
            ...
            {{else}}
            <button gateway="#page=signup;" class="right-menu btn-register hidden-on-mobile">
                <p>Регистрация</p>
            </button>
            <button gateway="#page=login;" class="right-menu btn-login">
